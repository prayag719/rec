...
<p style="color:blue;"><span style="color:black;">🔗</span><a href="{}" target="_blank" rel="noopener noreferrer">Link</a></p>
...
def main():
    ...
    # Display only the "Recommend" section
    st.subheader("Recommend Courses")

    # Load data
    df = load_data("C:\\Users\\RIT\\Desktop\\recommendation\\udemy_courses.csv")
